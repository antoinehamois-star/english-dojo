...
class Oklaschenkerv2 extends CarrierModule
{
     ...
     * Appelée UNIQUEMENT depuis AdminOklaschenkerv2Controller après une confirmation
    ...
    {
        if (Tab::getIdFromClassName('AdminOklaschenkerv2Controller')) {
            return true;
        }

        $tab = new Tab();
        $tab->class_name = 'AdminOklaschenkerv2Controller';
    ...
    {
        $idTab = (int) Tab::getIdFromClassName('AdminOklaschenkerv2Controller');
        if ($idTab <= 0) {
            return true;
        }
        $tab = new Tab($idTab);
