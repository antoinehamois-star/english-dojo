 ...
 */
class AdminOklaschenkerv2Controller extends AdminController
{
    /** @var Oklaschenker */
    public $module;
    ...
    public function __construct()
    {
        ...
        if (!$this->module instanceof Oklaschenker) {
            $this->module = Module::getInstanceByName('oklaschenkerv2');
        }
    }
    ...
    public function initContent()
    {
        ...
        $this->context->smarty->assign([
            'okla_config_form_action' => $this->context->link->getAdminLink('AdminOklaschenkerv2Controller'),
    ...
    {
        return _PS_MODULE_DIR_ . 'oklaschenkerv2/views/templates/admin/' . $template;
    }
    ...
    {
        $dataFile = _PS_MODULE_DIR_ . 'oklaschenkerv2/data/schenker_tarifs_extraits.json';
        try {
